...
public class HomePageSteps extends UiBase {
    ...
    @io.cucumber.java.en.Then("^I should see the title OUR TOP SERVICES$")
    public void iShouldSeeTheTitleOURTOPSERVICES() {
        WebElement element = uiBase.driver.findElement(By.tagName("h2"));
        Assert.assertEquals(element.getText(), "OUR TOP SERVICES");
    }
}
